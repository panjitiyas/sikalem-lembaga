...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Bendahara Pengeluaraan Pembantu</h1>
          </div> 
          <div class="col-sm-6">
  ...
  <div class="col-md-8 offset-md-2">
    <div class="card card-outline card-orange">
        <div class="card-header">
            <h3 class="card-title"><?=ucfirst($page)?> Data BPP</h3>
        </div>
        <div class="card-body">
          <div class="row">
              <div class="col-md-12">
                  <form action="<?=site_url('bpp/proses')?>" method="post">
                      <div class="form-group" > 
                          <label>Nama Bendahara*</label>
                          <input type="hidden" name="id" value=<?=$row->id_bpp?>>
                          <input type="text" name ="nm_bpp" class="form-control" value="<?=$row->nm_bpp?>"required>
                      </div>
                      ...
                      <div class="form-group float-right">
                          ...
                          <a href="<?=site_url('bpp')?>" class="btn btn-danger btn-sm"><i class="fas fa-times"></i> Batal</a>
                      </div>
                  </form>
              </div>
          </div>  
