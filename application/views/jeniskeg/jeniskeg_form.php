  ...
  <div class="col-md-8 offset-md-2">
    <div class="card card-outline card-orange">
        <div class="card-header">
            <h3 class="card-title"><?=ucfirst($page)?> Data Jenis Kegiatan</h3>
        </div>
        <div class="card-body">
          <div class="row">
              <div class="col-md-12">
                  <form action="<?=site_url('jeniskeg/proses')?>" method="post">
                      <div class="form-group" > 
                          <label>Jenis Kegiatan*</label>
                          <input type="hidden" name="id" value=<?=$row->id_jeniskeg?>>
                          <input type="text" name ="nm_jeniskeg" class="form-control" value="<?=$row->nm_jeniskeg?>"required>
                      </div>
                      ...
                      <div class="form-group float-right">
                          ...
                          <a href="<?=site_url('jeniskeg')?>" class="btn btn-danger btn-sm"><i class="fas fa-times"></i> Batal</a>
                      </div>
                  </form>
              </div>
          </div>  
