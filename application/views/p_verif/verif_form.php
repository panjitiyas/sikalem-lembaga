        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">
                <a href="<?=site_url('user')?>">Petugas Verifikator</a>
              </li>
            </ol>
          </div>
    </section>
  ...
  <div class="col-md-8 offset-md-2">
    <div class="card card-outline card-orange">
        <div class="card-header">
            <h3 class="card-title"><?=ucfirst($page)?> Data Verifikator</h3>
        </div>
        <div class="card-body">
          <div class="row">
              <div class="col-md-12">
                  <form action="<?=site_url('verif/proses')?>" method="post">
                      <div class="form-group" > 
                          <label>Nama*</label>
                          <input type="hidden" name="id" value=<?=$row->verifid?>>
                          <input type="text" name ="nm_verif" class="form-control" value="<?=$row->nm_verif?>"required>
                      </div>
                      <div class="form-group" >
                          <label>Email</label> 
                          <input type="text" name ="email_verif" class="form-control" value="<?=$row->email_verif?>"> 
                      </div>            
                      <div class="form-group float-right">
                          ...
                          <a href="<?=site_url('verif')?>" class="btn btn-danger btn-sm"><i class="fas fa-times"></i> Batal</a>
                      </div>
                  </form>
              </div>
          </div>  
