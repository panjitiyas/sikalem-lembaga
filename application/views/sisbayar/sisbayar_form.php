  ...
  <div class="col-md-8 offset-md-2">
    <div class="card card-outline card-orange">
        <div class="card-header">
            <h3 class="card-title"><?=ucfirst($page)?> Data Sistem Pembayaran</h3>
        </div>
        <div class="card-body">
          <div class="row">
              <div class="col-md-12">
                  <form action="<?=site_url('sisbayar/proses')?>" method="post">
                      <div class="form-group" > 
                          <label>Sistem Pembayaran*</label>
                          <input type="hidden" name="id" value=<?=$row->id_bayar?>>
                          <input type="text" name ="nm_bayar" class="form-control" value="<?=$row->nm_bayar?>"required>
                      </div>
                      ...
                      <div class="form-group float-right">
                          ...
                          <a href="<?=site_url('sisbayar')?>" class="btn btn-danger btn-sm"><i class="fas fa-times"></i> Batal</a>
                      </div>
                  </form>
              </div>
          </div>  
