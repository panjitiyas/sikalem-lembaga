              ...
              <td class="text-center" width="120px">
                <div class="btn-group">
                  ...
                  <?php if ($data->lampiran != null) { ?>
                    <a href="<?= base_url('uploads/dukung/' . $data->lampiran) ?>" class="btn btn-success btn-xs"><i class="fa fas fa-download"></i></a>
                  <?php } else { ?>
                    <a href="#" class="btn btn-secondary btn-xs disabled"><i class="fa fas fa-download"></i></a>
                  <?php } ?>
                  <a href="<?= site_url('tools/ubah/' . $data->id_tools) ?>" class="btn btn-info btn-xs"><i class="fas fa-pencil-alt"></i></a>
                  <a href="#hapus" onclick="$('#hapus #formHapus').attr('action','<?= site_url('tools/del/' . $data->id_tools) ?>' )" class="btn btn-danger btn-xs" data-toggle="modal"><i class="fas fa-trash"></i></a>
                </div>
              </td>
            </tr>
          <?php } ?>
